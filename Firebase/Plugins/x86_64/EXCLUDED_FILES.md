...
- `FirebaseCppApp-13_8_0.bundle` (189MB)
- `FirebaseCppApp-13_8_0.so` (122MB)
...
```
https://dl.google.com/games/registry/unity/com.google.firebase.app/com.google.firebase.app-13.8.0.tgz
```
