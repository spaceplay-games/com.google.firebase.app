...
- `FirebaseCppApp-13_10_0.bundle` (190MB)
- `FirebaseCppApp-13_10_0.so` (122MB)
...
```
https://dl.google.com/games/registry/unity/com.google.firebase.app/com.google.firebase.app-13.10.0.tgz
```
